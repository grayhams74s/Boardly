...
const Loader = () => (
  <div className="flex h-screen w-full flex-col items-center justify-center bg-white dark:bg-dark-bg">
    <InfinitySpin width="200" color="#3b82f6" />
    <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">Loading...</p>
  </div>
);
