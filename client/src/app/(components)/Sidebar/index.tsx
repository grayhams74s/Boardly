...
const Sidebar = () => {
  ...
  const sidebarClassNames =
    `fixed z-40 flex h-full flex-col justify-between overflow-y-auto bg-white shadow-xl transition-colors duration-300 dark:bg-dark-bg ${isSidebarCollapsed ? "hidden w-0" : "w-64"}`;

  return (
    <div className={sidebarClassNames}>
      {/* OUTER CONTAINER — fixed positioning, full height */}
      ...
      <div className="flex h-full w-full flex-col justify-start">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-stroke-dark">
          ...
          <div>
              ...
              <div className="flex gap-2 items-start">
                <LockIcon className="mt-[0.1rem] h-3 w-3 text-gray-300" />
        ...
        {showPriority ? <>
          ...
          <SidebarLink icon={Layers3} label="Backlog" href="/priority/backlogs"/>
          </> : <></>}

        {/* PRIORITIES SECTION (collapsible — toggled by showPriority) */}
